...
<li>Also displayed are smaller widgets of weather conditions for the next four days for that particular city</li>
</ul>
...
<ul>
<li>Our guest will have the ablilty to get the weather results from their current location</li>

<li>Instead of searching for the city that they are in, a user can click on the green location button to be updated with the current location forecast</li>
 </ul> 

 

https://github.com/tremitch504/The-Weather-App/assets/51865741/f5046908-9383-4356-be0c-ef77a0fba561
